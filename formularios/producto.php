                        ...
                        <form action="../objetos_guardar/producto.php"  method="post"  id="Producto" class="text-center border border-light p-3 shadow-lg rounded-lg" style="border-radius: 18px; margin-top: 25px;">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="clienteFK" name="clienteFK" placeholder="Cliente">
                                        <?php
                                        // Verificar si se obtuvo la lista de clientes correctamente
                                        if ($clientes !== null && count($clientes) > 0) {
                                            // Iterar sobre cada cliente y crear una opción para el select
                                            foreach ($clientes as $cliente) {
                                                echo "<option value='{$cliente['id_cliente']}'>{$cliente['nombre']}</option>";
                                            }
                                        } else {
                                            // Si no se pudo obtener la lista de clientes, mostrar un mensaje de error
                                            echo "<option value=''>Error al obtener los clientes</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="fecha_producto" value="<?php echo date('YYYY-MM-DD HH:MM:SS'); ?>">
                                </div>
                            </div>

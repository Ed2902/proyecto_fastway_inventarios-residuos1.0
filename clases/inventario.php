<?php
    ...
    class Inventario {
        ...
        public function __construct($fechaingreso, $cantidad, $fw, $id_productoFK, $id_usuarioFK, $id_clienteFK, $id_inventario = null) {
        ...
        public function guardar() {
            ...
            $consulta = $conexion->prepare("INSERT INTO inventario (fechaingreso, cantidad, fw, id_productoFK, id_usuarioFK, id_clienteFK) VALUES(:fechaingreso, :cantidad, :fw, :id_productoFK, :id_usuarioFK, :id_clienteFK)");
            $fechaActual = date("Y-m-d"); // Obtiene la fecha actual
        
            try {
                $consulta->bindParam(':fechaingreso', $fechaActual);
